...
function smarty_function_paginate_last($params, &$smarty) {
    ...
    return '<a class="btn-info" href="' . str_replace('&','&amp;', $_url) . '"' . $_attrs . '>' . $_text . '<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>';

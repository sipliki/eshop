...
function smarty_function_paginate_first($params, &$smarty) {
    ...
    return '<a class="btn btn-info" href="' . str_replace('&','&amp;', $_url) . '"' . $_attrs . '><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>' . $_text . '</a>';
}
